      ...
      <div className="harbor-manga-nowbar-in w-[min(440px,100%)]">
        ...
        >
          ...
          <span className="flex min-w-0 flex-1 flex-col">
            <span className="truncate text-[13.5px] font-semibold text-ink">{m.title || t("Reading")}</span>
            <span className="truncate text-[11.5px] text-ink-muted">{t("Reading {label}", { label: m.chapterLabel })}</span>
          </span>
