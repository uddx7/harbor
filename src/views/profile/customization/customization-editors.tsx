    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between gap-3 rounded-[10px] bg-elevated px-3 py-2.5 ring-1 ring-edge-soft">
        <div className="min-w-0">
          <div className="text-[13px] font-medium text-ink">{t("Show customization to visitors")}</div>
          <div className="text-[12px] text-ink-subtle">{t("Off keeps your font, background, and canvas as a private preview.")}</div>
        </div>
        <button
          type="button"
          role="switch"
      ...
      <div className="flex items-center justify-between gap-3 rounded-[10px] bg-elevated px-3 py-2.5 ring-1 ring-edge-soft">
        <div className="min-w-0">
          ...
          <div className="text-[12px] text-ink-subtle">{t("Let your full page background show without the top cover.")}</div>
        </div>
        <button
          type="button"
          role="switch"
      ...
      <div className="flex items-center justify-between gap-3 rounded-[10px] bg-elevated px-3 py-2.5 ring-1 ring-edge-soft">
        <div className="min-w-0">
          ...
          <div className="text-[12px] text-ink-subtle">{t("Drop the About and Custom labels so an embed fills the card cleanly.")}</div>
        </div>
        <button
          type="button"
          role="switch"
