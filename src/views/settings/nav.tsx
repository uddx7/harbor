...
function IconStreamBadges(p: IconProps) {
  return (
    <IconBase {...p}>
      ...
      <path d="M15.7 5h3.6" />
      <path d="M6.5 5.5l.6 1.3 1.3.6-1.3.6-.6 1.3-.6-1.3-1.3-.6 1.3-.6z" fill="currentColor" stroke="none" />
    </IconBase>
  );
}
...
function IconAward(p: IconProps) {
  return (
    <IconBase {...p}>
      ...
      <path d="M12 4.9l.62 1.3 1.43.19-1.04.98.25 1.42L12 8.29l-1.26.69.25-1.42-1.04-.98 1.43-.19z" fill="currentColor" stroke="none" />
    </IconBase>
  );
}
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        keywords: ["badges", "format badges", "quality badges", "chips", "4k badge", "hdr badge", "atmos badge", "remap", "custom badges", "nuvio", "badge pack", "import badges", "community badges"],
      },
      {
        id: "awardIcons",
        label: "Award icons",
        Icon: IconAward,
        keywords: ["award", "awards", "oscar", "emmy", "trophy", "award icons", "award pack", "custom award", "upload award icon", "crunchyroll awards", "install pack"],
      },
    ],
  },
  {
...
const SETTINGS_OPTIONS: SettingsOption[] = [
  ...
  { label: "Show pages (resume scroll)", section: "library", anchorTitle: "Show pages", keywords: ["show pages", "detail page", "resume scroll", "scroll position", "jump to episode", "jump back", "where you left off", "scroll flash", "stutter", "remember scroll", "episode list scroll", "auto scroll to episode"] },
  ...
  { label: "Hover style", section: "library", anchorTitle: "Metadata providers", keywords: ["hover style", "card hover", "poster hover", "peek", "marquee", "trailer card", "elegantfin", "frosted glass", "cinema", "spotlight", "minimal", "glare", "overview", "preview style"] },
  ...
  { label: "Stream priority", section: "streaming", anchorTitle: "Result order", keywords: ["stream priority", "prefer addon", "addon first", "aiostreams first", "which addon first", "addon priority", "torrentio last", "reorder addons for streams", "preferred addon"] },
  ...
  { label: "X-Ray (cast on screen)", section: "player", anchorTitle: "X-Ray (experimental)", keywords: ["xray", "x-ray", "cast", "whos on screen", "who is on screen", "actors in scene", "amazon xray", "face recognition", "whos here", "who's here"] },
  ...
  { label: "Audio downmix", section: "player", anchorTitle: "Audio", keywords: ["downmix", "stereo", "surround", "laptop speakers", "headphones", "fold down"] },
  ...
  { label: "Volume control", section: "playerLayout", keywords: ["volume slider", "stepper", "icon only", "mute click", "volume widget style", "hover slider", "volume boost", "louder", "vertical volume", "boost past 100", "amplify"] },
  ...
  { label: "Bar color", section: "playerLayout", anchorTitle: "Seek bar", keywords: ["seek bar color", "accent color", "recolor progress", "custom color", "gold accent"] },
  { label: "Bar image", section: "playerLayout", anchorTitle: "Seek bar", keywords: ["tiled pattern", "custom bar image", "gif bar", "texture upload", "pattern bar"] },
  { label: "Seek dot shape", section: "playerLayout", anchorTitle: "Seek bar", keywords: ["circle", "square", "custom image dot", "hidden dot", "handle shape", "no dot"] },
  { label: "Dot size", section: "playerLayout", anchorTitle: "Seek bar", keywords: ["handle size", "knob size", "image size", "bigger dot", "scrubber size"] },
  ...
  { label: "Automations", section: "webhooks", anchorTitle: "Automations", keywords: ["rules", "automations", "custom alert rules", "triggers", "ping rules", "rule list"] },
  { label: "New rule", section: "webhooks", anchorTitle: "Automations", keywords: ["create rule", "new automation", "when then", "tracked person trigger", "genre trigger", "streamer trigger", "country trigger", "live tv reminder", "lead minutes"] },
...
{ label: "Lock to season server", section: "basics", anchorTitle: "How Play works", keywords: ["season lock","season server","season pack","same source","lock source","no re-picking","play mode","sticky season","debrid season pack","lock series"] },
  ...
  { label: "Reset password (recovery key)", section: "account", anchorTitle: "Harbor account", keywords: ["forgot password","reset password","recovery key","backup code","recover account","lost password"] },
  { label: "Sign out of Harbor account", section: "account", anchorTitle: "Harbor account", keywords: ["sign out","logout","log off","harbor account","disconnect"] },
  { label: "Verified status", section: "account", anchorTitle: "Harbor account", keywords: ["verified","verification","verified badge","checkmark","ownership"] },
  { label: "Settings for this profile (shared or independent)", section: "account", anchorTitle: "Profiles", keywords: ["profile settings","shared settings","independent settings","per profile","separate preferences","settings scope","linked settings"] },
  ...
  { label: "AI search provider (OpenRouter / Groq)", section: "library", anchorTitle: "AI search", keywords: ["ai provider","openrouter","groq","search provider","llm provider","lpu","ai search backend"] },
  { label: "Custom model id", section: "library", anchorTitle: "AI search", keywords: ["custom model","model id","custom ai model","paste model","free variant","vendor model"] },
  { label: "Use live web context (Jina Reader)", section: "library", anchorTitle: "AI search", keywords: ["live web","jina","jina reader","web context","duckduckgo","web search ai","current results"] },
  { label: "Jina API key", section: "library", anchorTitle: "AI search", keywords: ["jina key","jina api","reader key","web quota","jina token"] },
  ...
  { label: "Show SIMKL score on cards", section: "library", anchorTitle: "Metadata providers", keywords: ["simkl","simkl score","simkl rating","card badge","community rating"] },
  { label: "Watched badge", section: "library", anchorTitle: "Metadata providers", keywords: ["watched badge","seen badge","watched marker","card watched","watched overlay","already watched"] },
  { label: "Local library", section: "library", anchorTitle: "Local library", keywords: ["local library","local files","on disk","offline files","my drive","folders","kodi nfo","local media"] },
  { label: "Show an on-disk badge on cards", section: "library", anchorTitle: "Local library", keywords: ["on disk badge","local badge","downloaded badge","have it","file exists","disk marker"] },
  ...
  { label: "Set active filter", section: "streamFilters", anchorTitle: "Saved stream filters", keywords: ["set active","active filter","apply filter","enable filter","use filter","current filter","default filter"] },
  { label: "Resolution filter", section: "streamFilters", anchorTitle: "Saved stream filters", keywords: ["resolution","4k","2160p","1080p","720p","480p","sd","quality"] },
  { label: "Source filter", section: "streamFilters", anchorTitle: "Saved stream filters", keywords: ["source","bluray","remux","web-dl","webrip","bdrip","hdrip","dvdrip","hdtv","cam"] },
  { label: "Codec filter", section: "streamFilters", anchorTitle: "Saved stream filters", keywords: ["codec","hevc","h265","x265","avc","h264","x264","av1","vp9","mpeg2"] },
  { label: "Audio filter", section: "streamFilters", anchorTitle: "Saved stream filters", keywords: ["audio","atmos","truehd","dts","dts-hd ma","dd+","ac3","aac","opus","flac"] },
  { label: "HDR only", section: "streamFilters", anchorTitle: "Saved stream filters", keywords: ["hdr","dolby vision","hdr10","hlg","high dynamic range","drop sdr","hdr only"] },
  { label: "Cached only", section: "streamFilters", anchorTitle: "Saved stream filters", keywords: ["cached","debrid","real-debrid","instant","already cached","library","cache only"] },
  { label: "Min seeders", section: "streamFilters", anchorTitle: "Saved stream filters", keywords: ["seeders","seeds","minimum seeders","min seeds","peers","torrent health","leechers"] },
  { label: "Max size (GB)", section: "streamFilters", anchorTitle: "Saved stream filters", keywords: ["max size","file size","size limit","gigabytes","gb","cap size","maximum size"] },
  ...
  { label: "RAVU Lite prescaler", section: "shaders", anchorTitle: "More picture shaders", keywords: ["ravu","ravu lite","luma prescaler","prescaler","luma doubler","anime upscale","radius","cheap shader"] },
  { label: "NNEDI3 neural upscaler", section: "shaders", anchorTitle: "More picture shaders", keywords: ["nnedi3","neural upscaler","edge directed","luma doubler","neurons","high quality upscale","heavy shader","32 64 128 neurons"] },
  { label: "SSimSuperRes detail refinement", section: "shaders", anchorTitle: "More picture shaders", keywords: ["ssimsuperres","ssim superres","detail refine","recover detail","post upscale","restore sharpness","detail restore"] },
  { label: "KrigBilateral chroma upscaler", section: "shaders", anchorTitle: "More picture shaders", keywords: ["krigbilateral","krig","chroma upscaler","chroma scaling","color blur","color bleed","saturated edges","chroma"] },
  { label: "Adaptive Sharpen", section: "shaders", anchorTitle: "More picture shaders", keywords: ["adaptive sharpen","sharpener","edge aware sharpen","sharpening","soft detail","no halos","alternative to cas"] },
  { label: "Content advisory on start", section: "playerLayout", anchorTitle: "While you watch", keywords: ["content advisory","parental guide","content warning","imdb","violence","profanity","maturity","severity","start toast"] },
  { label: "Buffer fill", section: "playerLayout", anchorTitle: "Seek bar", keywords: ["buffer fill","buffered","download ahead","cache indicator","seek bar buffer","loaded portion","buffer bar"] },
  { label: "Buffer fill brightness", section: "playerLayout", anchorTitle: "Seek bar", keywords: ["buffer brightness","buffer opacity","fill opacity","dim buffer","buffer transparency","buffer fill brightness","seek buffer brightness"] },
  { label: "Navigation", section: "hotkeys", anchorTitle: "Navigation", keywords: ["navigation","tv remote","arrow keys","focus navigation","remote control","keyboard nav","d-pad"] },
  { label: "TV navigation", section: "hotkeys", anchorTitle: "Navigation", keywords: ["tv navigation","arrow keys","focus","remote","spatial navigation","d-pad","enter select"] },
  { label: "TV navigation in player", section: "hotkeys", anchorTitle: "Navigation", keywords: ["player navigation","arrows in player","control focus","remote in player","spatial nav player","select space"] },
  { label: "Short seek (Shift + arrows)", section: "hotkeys", anchorTitle: "Behavior", keywords: ["short seek","shift arrows","small jump","nudge seconds","fine seek","shorter jump","seek step"] },
  { label: "Short seek back", section: "hotkeys", anchorTitle: "Player", keywords: ["short rewind","shift left","small jump back","nudge back","fine rewind","shift arrow left"] },
  { label: "Short seek forward", section: "hotkeys", anchorTitle: "Player", keywords: ["short skip forward","shift right","small jump ahead","nudge forward","fine forward","shift arrow right"] },
  { label: "Enable controller", section: "controllers", anchorTitle: "Controller support", keywords: ["enable controller","turn on gamepad","disable controller","controller on off","toggle gamepad","activate controller","controller support"] },
  { label: "Live controller preview", section: "controllers", anchorTitle: "Controller support", keywords: ["live preview","test controller","input test","button test","controller diagram","xbox layout","playstation layout","mirror inputs"] },
  { label: "Connected controllers", section: "controllers", anchorTitle: "Connected controllers", keywords: ["connected controllers","detected controllers","paired controller","recognized gamepad","controller list","usb bluetooth controller"] },
  { label: "Button map", section: "controllers", anchorTitle: "Button map", keywords: ["button map","button mapping","controls reference","what buttons do","browsing controls","player controls","d-pad","bumpers triggers"] },
  ...
  { label: "Poster dock magnification", section: "theme", anchorTitle: "Poster card style", keywords: ["dock magnification","magnify posters","poster zoom","hover magnify","mac dock","animation speed","poster row zoom"] },
  ...
  { label: "Test badge rules (Try it)", section: "badges", anchorTitle: "Custom rules", keywords: ["test badge","preview badge","try badge rule","sample stream name","badge preview","test rule"] },
  { label: "Tracked person release rule", section: "webhooks", anchorTitle: "Automations", keywords: ["tracked person alert","person trigger","someone i track","follow actor release","director new release","cast release ping","watched people automation"] },
  { label: "Genre release rule", section: "webhooks", anchorTitle: "Automations", keywords: ["genre alert","genre trigger","specific genre releases","genre automation","movies series genre","genre ping"] },
  { label: "Streamer release rule", section: "webhooks", anchorTitle: "Automations", keywords: ["streamer alert","provider trigger","netflix disney max release","crunchyroll release","streaming service automation","streamer ping"] },
  { label: "Country release rule", section: "webhooks", anchorTitle: "Automations", keywords: ["country alert","country trigger","region release","japan korea us release","country automation","country ping"] },
  { label: "Live TV reminder", section: "webhooks", anchorTitle: "Automations", keywords: ["live tv alert","iptv reminder","program about to start","epg reminder","lead time minutes","favorited channels","heads up notification","live tv rule"] },
  { label: "Enable or disable rule", section: "webhooks", anchorTitle: "Automations", keywords: ["turn off rule","pause automation","disable rule","enable rule","rule toggle","mute automation"] },
  { label: "Rule notify channels", section: "webhooks", anchorTitle: "Automations", keywords: ["notify on discord","notify on telegram","rule channel","route rule","then notify","per rule destination"] },
  { label: "Contact email or Discord", section: "bug", anchorTitle: "Credit (optional)", keywords: ["email","discord","contact","reach you","follow up","get in touch","reporter contact","handle"] },
  { label: "Continue Watching suggestions cache", section: "storage", anchorTitle: "Clear caches", keywords: ["continue watching","resurface","suggestions cache","cw cache","home rail","rewatch picks","clear resurface","recommendations cache"] },
