const chrome: Record<string, string> = {
  ...
  "welcome.subtitle": "Интерфейс теперь на русском. Сменить язык можно в любой момент в настройках.",
  ...
  "Profile is locked. Enter the 4-digit PIN to continue.": "Профиль заблокирован. Введите 4-значный PIN, чтобы продолжить.",
  ...
  "Pick a 4-digit PIN. You'll be asked for it before this profile opens.": "Придумайте 4-значный PIN. Он потребуется при открытии этого профиля.",
  ...
  "Use the primary profile's Stremio library, watchlist, and addons.": "Использовать библиотеку Stremio, список к просмотру и дополнения основного профиля.",
  "Use a separate Stremio account": "Использовать отдельный аккаунт Stremio",
  "Sign in from the sidebar after saving. Library and addons stay separate.": "После сохранения войдите через боковую панель. Библиотека и дополнения останутся отдельными.",
  "Delete profile": "Удалить профиль",
  "Delete this profile?": "Удалить этот профиль?",
  "Save changes": "Сохранить изменения",
  "Create profile": "Создать профиль",
  "Only the primary profile can edit other profiles.": "Изменять другие профили может только основной профиль.",
  "PIN on": "PIN включён",
  ...
  "Pick a PIN and which sidebar tabs require it.": "Задайте PIN и выберите разделы, для которых он нужен.",
  "4-digit PIN is set.": "4-значный PIN задан.",
  "No PIN set.": "PIN не задан.",
  "Set PIN": "Задать PIN",
  "Sidebar access": "Доступ к разделам",
  "No locks. All sidebar tabs open without a PIN.": "Блокировок нет. Все разделы открываются без PIN.",
